...
namespace PIBcl.EventBus.RabbitMQEventBus
{
    public class EventBusRabbitMQ : IEventBus, IDisposable
    {
        ...
        public EventBusRabbitMQ(IRabbitMQPersistentConnection persistentConnection, ILogger<EventBusRabbitMQ> logger,
            ILifetimeScope autofac, IEventBusSubscriptionsManager subsManager, string exchangeName, string queueName = null, int retryCount = 5)
        {
            _exchangeName = exchangeName;
            _autoFacScopeName = exchangeName;
        ...
        public void Unsubscribe<TH>(string eventName)
            where TH : IDynamicIntegrationEventHandler
        {
